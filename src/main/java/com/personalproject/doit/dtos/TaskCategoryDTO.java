...
public class TaskCategoryDTO {
    ...
    public TaskCategoryDTO(Long id, String title, String description, LocalDateTime startDate, LocalDateTime finishDate, Integer priority, ToDoStatus taskStatus) {
        this.id = id;
        this.title = title;
    ...
    public TaskCategoryDTO(Task entity) {
        id = entity.getId();
